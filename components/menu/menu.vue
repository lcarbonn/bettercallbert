        ...
        <b-collapse id="nav-collapse"
            ...
            <b-navbar-nav align="left">
                <b-nav-item>
                    <a href="#"
                       class="menu-item"
                       v-bind:class="{activelink:isActive('')}"
                       v-on:click="setActive('')">All</a>
                </b-nav-item>
                <b-nav-item v-for="menu in menus"
                            v-bind:key="menu.id">
                    <a href="#"
                       class="menu-item"
                       v-bind:class="[{activelink:isActive(menu.id)}, menu.color]"
...
export default {
    ...
    methods: {
        isActive: function (menu) {
            // console.debug('active menu:'+this.activeMenu);
